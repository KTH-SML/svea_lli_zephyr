...
/**
 * Control external precharge (PCHG) pin if provided via devicetree
 *
 * @param enable true to enable precharge path, false to disable
 * @return 0 on success, negative error if unavailable or failed
 */
